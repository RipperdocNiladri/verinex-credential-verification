  ...
  return (
    <div className="overflow-hidden">
      <header className="mx-auto flex max-w-7xl items-center justify-between px-5 py-5 md:px-8">
        <Link href="/" className="flex items-center gap-2.5" data-testid="link-home-brand"><BrandMark /><span className="font-semibold tracking-[-.025em]">VeriNex</span></Link>
      ...
      <main>
        <section className="relative mx-auto max-w-7xl px-5 pb-20 pt-16 md:px-8 md:pb-28 md:pt-24">
          ...
          <div className="relative grid items-center gap-14 lg:grid-cols-[1fr_440px]">
            <div className="max-w-3xl">
              ...
              <p className="fade-up fade-up-delay-2 mt-8 max-w-lg text-lg leading-8 text-[hsl(var(--muted-foreground))]">Verification of Next-Generation Credentials</p>
        ...
        <section className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-28">
          <div className="grid gap-12 md:grid-cols-[.7fr_1fr] md:items-end"><div><p className="mb-3 font-mono-ui text-[10px] uppercase tracking-[.18em] text-[hsl(var(--primary))]">For careful teams</p><h2 className="font-display text-5xl leading-none tracking-[-.035em] md:text-6xl">A second pair of eyes<br /><em>with a paper trail.</em></h2></div><p className="max-w-md text-base leading-7 text-[hsl(var(--muted-foreground))]">Recruiters, admissions teams, and compliance reviewers use VeriNex when “looks right” is not enough. Every result keeps the reasoning close to the decision.</p></div>
      ...
      <footer className="border-t border-[hsl(var(--border))]"><div className="mx-auto flex max-w-7xl flex-col gap-4 px-5 py-7 text-xs text-[hsl(var(--muted-foreground))] md:flex-row md:items-center md:justify-between md:px-8"><span>VeriNex / academic verification workspace</span><span className="font-mono-ui text-[10px] uppercase tracking-wider">Demo records clearly marked</span></div></footer>
    </div>
  );
}